...
class Player(pygame.sprite.Sprite):
    def __init__(self, animations, pos, collision_sprites, *groups):
        ...
        self.damage_sound = pygame.mixer.Sound(path.join('audio','impact.ogg'))
        self.damage_sound_cooldown = 1500
        self.damage_sound_last_player = pygame.time.get_ticks()
    ...
    def enemy_collision(self,enemies,dt):
        ...
        for enemy in collided:
            ...
            self.play_damage_sound_if_ready()
    ...
    def play_damage_sound_if_ready(self):
        if pygame.time.get_ticks()-self.damage_sound_last_player>self.damage_sound_cooldown:
